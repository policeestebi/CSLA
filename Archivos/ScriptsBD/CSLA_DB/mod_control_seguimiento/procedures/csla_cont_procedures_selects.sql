...
END  
 GO
  ...
  IF  EXISTS (SELECT * FROM sys.procedures WHERE object_id = OBJECT_ID(N'[dbo].[PA_cont_actividadesProyectoSelectOne]'))
DROP PROCEDURE [dbo].[PA_cont_actividadesProyectoSelectOne]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
-- Descripción: 
-- =============================================
CREATE PROCEDURE  PA_cont_actividadesProyectoSelectOne
  @paramPK_proyecto int,
  @paramPK_paquete int
AS 
 BEGIN 
