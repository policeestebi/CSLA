                                    ...
                                    <td>
                                        ...
                                        <table id="tbl_mantenimiento">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_menu" runat="server"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:RequiredFieldValidator ID="rfv_menu" runat="server" ControlToValidate="txt_menu"
                                                        ToolTip="Ingrese el código del menu" ErrorMessage="Código es requerido"><img alt="imagen" width="25px" height="20px" src="../../App_Themes/Basico/botones/img_warning.gif" border="none"/></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="rev_menu" ControlToValidate="txt_menu" runat="server"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_titulo" runat="server" Height="15px" Width="250px" TextMode="MultiLine"></asp:TextBox>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_descripcion" Width="350px" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                </td>
                                                <td>
