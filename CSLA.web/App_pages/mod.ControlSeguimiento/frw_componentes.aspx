<%@ Page Title="" Language="C#" MasterPageFile="~/msp.EstiloBasico/mspContenido.Master"
    AutoEventWireup="true" CodeBehind="frw_componentes.aspx.cs" Inherits="CSLA.web.App_pages.mod.ControlSeguimiento.frw_componentes" %>
            ...
            <act:Accordion ID="ard_principal" runat="server" SelectedIndex="0" FadeTransitions="false"
                ...
                <Panes>
                    <act:AccordionPane ID="acp_listadoDatos" runat="server">
                        <Header>
                            <a href="" style="color: #FFFFFF; font-size: 12px;">Listado de Componentes</a>
                        </Header>
                        <Content>
                            <table id="tbl_contenido">
                                ...
                                <tr>
                                    <td>
                                        <%-- Búsqueda--%>
                                        <cc1:ucSearch ID="ucSearchComponente" runat="server" OnSearchClick="ucSearchComponente_searchClick" />
                                ...
                                <tr>
                                    <td>
                                        <%-- GridView--%>
                                        <asp:GridView ID="grd_listaComponente" AllowPaging="True" runat="server" AutoGenerateColumns="False"
                                            Width="100%" CssClass="Grid" CellSpacing="1" CellPadding="3" OnRowCommand="grd_listaComponente_RowCommand"
                                            OnPageIndexChanging="grd_listaComponente_PageIndexChanging">
                                            <PagerSettings PageButtonCount="20" />
                                            <Columns>
                                                <asp:BoundField DataField="pPK_componente" HeaderText="Componente" SortExpression="pPK_componente" />
                    ...
                    <act:AccordionPane ID="acp_edicionDatos" runat="server">
                        <Header>
                            <a href="" style="color: #FFFFFF; font-size: 12px;">Edici&oacute;n de Componentes</a>
                        </Header>
                        <Content>
                            <table id="Table1">
                                <tr>
                                            ...
                                            <tr align="left">
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="rfv_codigo" runat="server" ControlToValidate="txt_codigo"
                                                        ToolTip="Ingrese el código del componente" ErrorMessage="Código es requerido"><img alt="imagen" width="25px" height="20px" src="../../App_Themes/Basico/botones/img_warning.gif" border="none"/></asp:RequiredFieldValidator>
                                            ...
                                            <tr align="left">
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="rfv_nombre" runat="server" ControlToValidate="txt_nombre"
                                                        ToolTip="Ingrese el nombre del componente" ErrorMessage="Componente es requerido"><img alt="imagen" width="25px" height="20px" src="../../App_Themes/Basico/botones/img_warning.gif" border="none"/></asp:RequiredFieldValidator>
                                            ...
                                            <tr align="left">
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="rfv_descripcion" runat="server" ControlToValidate="txt_descripcion"
                                                        ToolTip="Ingrese la descripción del componente" ErrorMessage="Descripción es requerida"><img alt="imagen" width="25px" height="20px" src="../../App_Themes/Basico/botones/img_warning.gif" border="none"/></asp:RequiredFieldValidator>
