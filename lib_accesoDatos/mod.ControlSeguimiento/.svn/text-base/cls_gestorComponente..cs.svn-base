       ...
       public static List<cls_componente> listarComponenteFiltro(string psFiltro)
       {
           ...
           try
           {
               ...
               for (int i = 0; i < vu_dataSet.Tables[0].Rows.Count; i++)
               {
                   ...
                   voComponente.pCodigo = vu_dataSet.Tables[0].Rows[0]["codigo"].ToString();

                   voComponente.pNombre = vu_dataSet.Tables[0].Rows[0]["nombre"].ToString();

                   voComponente.pDescripcion = vu_dataSet.Tables[0].Rows[0]["descripcion"].ToString();
