    ...
    public class cls_gestorEntregable
    {
	   ...
	   public static int insertEntregable(cls_entregable poEntregable)
        {
            ...
            try
            {
                ...
                cls_interface.insertarTransacccionBitacora(cls_constantes.INSERTAR, cls_constantes.ENTREGABLE, poEntregable.pPK_entregable.ToString());
       ...
       public static int updateEntregable(cls_entregable poEntregable)
       {
            ...
            try
            {
                ...
                cls_interface.insertarTransacccionBitacora(cls_constantes.MODIFICAR, cls_constantes.ENTREGABLE, poEntregable.pPK_entregable.ToString());
       ...
       public static int deleteEntregable(cls_entregable poEntregable)
       {
            ...
            try
            {
                ...
                cls_interface.insertarTransacccionBitacora(cls_constantes.ELIMINAR, cls_constantes.ENTREGABLE, poEntregable.pPK_entregable.ToString());
       ...
       public static List<cls_entregable> listarEntregableFiltro(string psFiltro)
       {
           ...
           try
           {
               ...
               for (int i = 0; i < vu_dataSet.Tables[0].Rows.Count; i++)
               {
                   ...
                   voPermiso.pCodigo = vu_dataSet.Tables[0].Rows[0]["codigo"].ToString();

                   voPermiso.pNombre = vu_dataSet.Tables[0].Rows[0]["nombre"].ToString();

                   voPermiso.pDescripcion = vu_dataSet.Tables[0].Rows[0]["descripcion"].ToString();
