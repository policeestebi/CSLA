    ...
    public class cls_gestorPaquete
    {
	   ...
	   public static int insertPaquete(cls_paquete poPaquete)
       {
            ...
            try
            {
                ...
                cls_interface.insertarTransacccionBitacora(cls_constantes.INSERTAR, cls_constantes.PAQUETE, poPaquete.pPK_Paquete.ToString());
       ...
       public static int updatePaquete(cls_paquete poPaquete)
       {
                ...
                try
                {
                    ...
                    cls_interface.insertarTransacccionBitacora(cls_constantes.MODIFICAR, cls_constantes.PAQUETE, poPaquete.pPK_Paquete.ToString());
       ...
       public static int deletePaquete(cls_paquete poPaquete)
       {
                ...
                try
                {
                    ...
                    cls_interface.insertarTransacccionBitacora(cls_constantes.ELIMINAR, cls_constantes.PAQUETE, poPaquete.pPK_Paquete.ToString());
       ...
       public static List<cls_paquete> listarPaqueteFiltro(string psFiltro)
       {
           ...
           try
           {
               ...
               for (int i = 0; i < vu_dataSet.Tables[0].Rows.Count; i++)
               {
                   ...
                   voPaquete.pPK_Paquete = Convert.ToInt32(vu_dataSet.Tables[0].Rows[0]["PK_paquete"]);

                   voPaquete.pCodigo = vu_dataSet.Tables[0].Rows[0]["codigo"].ToString();

                   voPaquete.pNombre = vu_dataSet.Tables[0].Rows[0]["nombre"].ToString();

                   voPaquete.pDescripcion = vu_dataSet.Tables[0].Rows[0]["descripcion"].ToString();
